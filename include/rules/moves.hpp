...
uint64_t A_vertical = 0x0101010101010101ULL;
uint64_t B_vertical = 0x0202020202020202ULL;
uint64_t G_vertical = 0x4040404040404040ULL;
uint64_t H_vertical = 0x8080808080808080ULL;

uint64_t eight_horizontal =   0xFF00000000000000ULL;
uint64_t seven_horizontal =   0xFF000000000000ULL;
uint64_t two_horizontal =     0xFF00ULL;
uint64_t one_horizontal =     0xFFULL;
...
public:
    ...
    uint64_t allKnightsMoves(uint64_t knights, uint64_t board, uint64_t boardEnemy);
